...
part3Router.get('/balance', requireAuth, asyncHandler(async (req, res) => {
...
part3Router.post('/deposit', requireAuth, asyncHandler(async (req, res) => {
...
part3Router.post('/withdraw', requireAuth, asyncHandler(async (req, res) => {
    ...
    try {
        const { updated, tx } = await prisma.$transaction(async (prismaTx) => {
            ...
            const currentBalance = account[stablecoinKey] || 0;
...
part3Router.post('/transfer', requireAuth, asyncHandler(async (req, res) => {
...
part3Router.get('/transactions', requireAuth, asyncHandler(async (req, res) => {
    const sxId = req.user.walletAddress.toLowerCase();
