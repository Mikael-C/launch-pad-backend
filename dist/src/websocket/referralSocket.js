...
async function sendReferralUpdate(client) {
    if (!client.walletAddress || client.ws.readyState !== WebSocket.OPEN)
        return;
    try {
...
export function broadcastToWallet(walletAddress, data) {
    for (const client of clients) {
